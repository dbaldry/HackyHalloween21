...
export function InstallationContent({
  ...
  return (
    <>
      ...
      <Paragraph>
        To help you get started, we are going to create a content type for which stores the JSON schema. 
      </Paragraph>
      <TextField
        ...
        helpText="You use this content type to store the JSON schema"
