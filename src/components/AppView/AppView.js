...
export class AppView extends Component {
  ...
  state = {
    isInstalled: false,
    allContentTypesIds: [],
    contentTypeId: camelCase('jsonSchema'),
    contentTypeName: 'json Schema',
    ...
    return (
      <>
        ...
        <div className={styles.body}>
          <Typography>
            <Heading className={styles.heading}>About No Code JSON Editor</Heading>
            <Paragraph>
              The No Code JSON Editor app enables users to complete JSON data that follows a defined JSON Schema.
            </Paragraph>
            <Divider />
            {isInstalled && <ConfigurationContent sdk={this.props.sdk} />}      
